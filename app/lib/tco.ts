...
export const getSeriesSummary = (distance: number, profile: DriveProfileKey) =>
...
export const DRIVE_PROFILE_OPTIONS = (Object.keys(DRIVE_PROFILES) as Array<DriveProfileKey>).map(
  (key) => ({
    key,
